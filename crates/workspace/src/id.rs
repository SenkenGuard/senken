...
/// A workspace's primary key.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct WorkspaceId(Uuid);

/// A layout's primary key.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
/// A layer's primary key.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct LayerId(Uuid);

/// A drawing's primary key.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
