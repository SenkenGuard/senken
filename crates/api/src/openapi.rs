...
use crate::dto::{
    ...
    CreateDashboardWorkspaceRequest, CreateNoteRequest, CreateRoleRequest,
    CreateTradeAccountRequest, CreateUserRequest, CreateWatchlistGroupRequest,
    CreateWorkspaceRequest, DashboardDataSourceDto, DashboardGridSizeDto, DashboardLayoutDto,
    DashboardWidgetCatalogResponse, DashboardWidgetDefinitionDto, DashboardWidgetDto,
    DashboardWidgetPlacementRequest, DashboardWorkspaceDto, DashboardWorkspacesPage,
    DefaultDashboardWorkspaceResponse, DefaultWorkspaceResponse, DeleteStorageRequest,
    DeleteStorageResponse, DownloadM1Request, DrawingDto, DrawingInputDto, DrawingKindDto,
    DrawingLineStyleDto, DrawingPointDto, EnsureBarsRequest, EnsureBarsResponse, ErrorBody,
    FillDto, GrantDto, HealthDto, IdResponse, IndicatorCatalogEntry, IndicatorDrawableDto,
    ...
    NoteSummaryDto, NotesPage, OrderDto, PaneDto, PaneInputDto, PlaceOrderRequest,
...
use crate::plugin_handlers::{
    ContributionKindDto, InstallPluginResponse, PluginDto, PluginKindDto, PluginListResponse,
    PluginStateDto, SetPluginEnabledRequest,
};
...
use crate::{
    ...
    indicator_handlers, instrument_handlers, notes_handlers, plugin_handlers, source_handlers,
    storage_handlers, trade_handlers, user_indicator_handlers, watchlist_handlers,
    widget_plugin_handlers, workspace_handlers, ws,
};
...
#[openapi(
    ...
    paths(
        ...
        user_indicator_handlers::list_my_indicators,
        user_indicator_handlers::get_my_indicator,
        user_indicator_handlers::create_my_indicator,
        user_indicator_handlers::update_my_indicator,
        user_indicator_handlers::recompile_my_indicator,
        user_indicator_handlers::delete_my_indicator,
        user_indicator_handlers::my_indicator_toolchain,
        ...
        plugin_handlers::get_plugin,
        plugin_handlers::install_plugin,
        plugin_handlers::uninstall_plugin,
        plugin_handlers::refresh_plugins,
